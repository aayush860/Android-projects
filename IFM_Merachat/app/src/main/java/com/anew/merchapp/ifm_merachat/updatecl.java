...
public class updatecl extends AppCompatActivity {
    ProgressBar pbb;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        {
            urlxx="https://indianfoodmrt.000webhostapp.com/admin/updater.php";
        }
        else if(cccc.equals("outlet2"))
        {
            urlxx="https://ifmifm2.000webhostapp.com/updater.php";
        }
        else if(cccc.equals("outlet3"))
        {
            urlxx="https://ifmifm3.000webhostapp.com/admin/updater.php";
        }
        else if(cccc.equals("outlet4"))
        {
            urlxx="https://ifmifm4.000webhostapp.com/admin/updater.php";
        }
        else if(cccc.equals("outlet5"))
        {
            urlxx="https://ifmifm6.000webhostapp.com/admin/updater.php";
        }
...
try {
    nm.setText(ar1[2].toString());
    ratn.setText(ar1[3].toString());
    brn.setText(ar1[4].toString());
}
catch(Exception e)
{
    nm.setText("");
...
valx="list2";
                ...
                {
                    Toast.makeText(updatecl.this, "Please fill all details", Toast.LENGTH_SHORT).show();
    ...
    public class SendPostRequest extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... arg0) {
            ...
            try {
                ...
                postDataParams.put("newprodname", npn);
...
//                Toast.makeText(getApplicationContext(), s, Toast.LENGTH_SHORT).show();
    ...
    public void loadIntoListView(String json) throws JSONException {
        ...
        Intent in=new Intent(updatecl.this,listview1.class);
